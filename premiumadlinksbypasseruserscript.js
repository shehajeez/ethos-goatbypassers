// ==UserScript==
// @name         (GOATBYPASSERS) Ethos Adlinks Bypasser (Premium)
// @namespace    https://ethos.kys.gay
// @version      1.0
// @description  Bypasses adlinks using the Ethos API (Premium)
// @author       shehajeez (from ethos, gb team)
...
(function() {
    ...
    const apikey = 'your_api_key_here';  // Paste in your Ethos Premium API Key here!
    const currenturl = window.location.href;

    fetch('https://ethos.kys.gay/api/bypass?url=' + encodeURIComponent(currenturl), {
        method: 'GET',
        headers: {
            'x-api-key': apikey
        }
